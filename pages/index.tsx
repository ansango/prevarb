      ...
      <main>
        ...
        <div className="grid md:grid-cols-2 gap-20 bg-gray-200 py-10 md:py-16">
          <div className="text-center space-y-10 m-auto">
            ...
            <p className="px-14">
              Todos los meses organizamos talleres y clases de formación relacionados con un estilo
              de vida sostenible y una alimentación saludable
            </p>
            <ButtonPrimary>
        ...
        <ContainerContent>
          ...
          <Review
            user={{ id: 1, fullName: "Francisco Jimenez", avatar: avatar }}
            review={{
              title: "Lo mejor en comercio local",
              content:
