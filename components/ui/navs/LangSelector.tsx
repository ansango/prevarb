...
const LangSelector = () => {
    ...
    return (
        <Menu as="div" className="relative inline-block text-left">
            <div>
                <Menu.Button className="flex items-center justify-center px-2 h-9 text-primary bg-gray-200 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 uppercase">
                    {locale}
                    <ChevronDownIcon
